...
See `WINNING_MODEL.md` for the evidence-first hybrid research policy and budget-aware route planner. Core identity and publication decisions remain deterministic; optional AI is constrained to evidence ranking/synthesis.
